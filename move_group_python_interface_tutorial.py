...
class MoveGroupPythonIntefaceTutorial(object):
 ...
 ####################### GO TO POSE ##########################################################################
  ...
  def go_to_pose_goal(self, a, b, c, roll, pitch, yaw, steps):
    ...
    #initial position
    xs = current_pose.position.x
    ys = current_pose.position.y
    zs = current_pose.position.z
    #final position
    xe = a #from keyboard
    ye = b
    ze = c + 0.05
 ...
 ######################################################################
  ...
  def add_box(self, a, b, c, roll, pitch, yaw, timeout=4):
...
def main():
  ...
  try:
    ...
    pose_retire = geometry_msgs.msg.PoseStamped()
    ...
    a = float(input('Insert the x coordinate for box_pose: '))
    b = float(input('Insert the y coordinate for box_pose: '))
    c = float(input('Insert the z coordinate for box_pose: '))

    #input("============ Press `Enter` to add table to the planning scene ...")
    #tutorial.add_table()

    input("============ Press `Enter` to add a box to the planning scene ...")
    tutorial.add_box(a, b, c, roll, pitch, yaw)
    
    input("============ Press `Enter` to execute a movement using a pose goal ...")
    tutorial.go_to_pose_goal(a, b, c, roll, pitch, yaw, 10)
    
    input("============ Press `Enter` to attach a Box to the Fanuc robot ...")
    tutorial.attach_box()
    
    a = float(input('Insert the x coordinate for pose_goal: '))
    b = float(input('Insert the y coordinate for pose_goal: '))
    c = float(input('Insert the z coordinate for pose_goal: '))
    ...
    pose_retire.pose.position.x = float(input('Insert the x coordinate for pose_goal: '))
    pose_retire.pose.position.y = float(input('Insert the y coordinate for pose_goal: '))
    pose_retire.pose.position.z = float(input('Insert the z coordinate for pose_goal: '))
    
    input("============ Press `Enter` to execute a movement using a pose goal ...")
    tutorial.go_to_pose_goal(pose_retire, roll, pitch, yaw, 10)
